...
Include: our angle, key takeaways to share, content formats (X thread / carousel / PDF), original vs our version comparison.
...
If only metadata is accessible: explicitly label as fallback and ask before treating as final result.
